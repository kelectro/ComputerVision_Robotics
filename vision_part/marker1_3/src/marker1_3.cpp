...
vector<Point2f> cont(Mat&img)
    {
           ...
           for( int i = 0; i<contours.size(); i++ )
        {
            ...
            //keep only circles depending on the (4*pi^2*radius^2)/(2*pi*radius)^2
            //closer to 1 better circle
...
vector<Point2f>Vision(Mat& img,Mat sample,int flag)
    {
...
int main(int argc, char* argv[])
{
    ...
    vector<Point2f>coordinates;
    Mat sample=imread("/home/student/Desktop/rovi_final/markers/Marker3.ppm");
    Mat img=imread("/home/student/Desktop/rovi_final/vision_part/marker_corny/sequence_3/marker_corny_01.png");

    coordinates=Vision(img,sample,2);
